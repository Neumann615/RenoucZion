...
export const NAV_DATA: NavData[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: "diagrams.net",
        desc: "开源免费图表工具，支持流程图/UML/架构图，跨平台实时协作",
        link: "https://www.drawio.com/",
      },
      {
        icon: "https://img-bed.renouc.cn/v2/3Lzo0Fh.png",
        title: "cdnjs",
        desc: "开源免费公共CDN，托管数千前端库与工具，全球加速分发",
  ...
  },
  {
    ...
    items: [
      ...
      {
        badge: "对话",
        icon: "https://img.alicdn.com/imgextra/i1/O1CN01cOgO0228KfUaIUM9k_!!6000000007914-54-tps-150-150.apng",
        title: "最强大的千问语言模型",
      ...
      {
        badge: "UI生成",
        icon: "https://v0.dev/chat-static/assets/icon-dark-192x192.png",
        title: "v0",
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: "https://tanstack.com/_build/assets/logo-color-600w-Er4SOkq1.png",
        title: "TanStack",
        desc: "前端工具库集合，专注高效数据管理与UI开发。",
        link: "https://tanstack.com",
      },
      {
        icon: "https://react-icons.github.io/react-icons/favicon.png",
        title: "React Icons",
        desc: "React 图标方案，集成 30+ 主流图标库，支持按需加载/树摇优化",
        link: "https://react-icons.github.io/react-icons/",
      },
      {
        icon: "https://ui.shadcn.com/favicon.ico",
        title: "shadcn-ui",
        desc: "基于 Radix 和 Tailwind 的可定制组件库，代码即设计，开箱即用",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: "CSS技巧与教程",
        desc: "深入解析CSS最新特性、布局技术与浏览器兼容性实践，提供实用代码示例。",
        link: "https://css-tricks.com",
      },
      {
        title: "clsx",
        desc: "轻量级类名组合工具，支持条件判断与嵌套对象",
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: "https://dioxuslabs.com/assets/favicon-c30fbcd6374b6976.png",
        title: "Dioxus",
        desc: "Rust高性能跨平台UI框架，内存安全多端开发",
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "http-server",
        desc: "零配置本地静态服务器，支持目录索引/CORS/HTTPS，开发调试利器",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "体系化 JS 教程，覆盖 ES6+/异步/API，含交互示例与习题",
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "BigFrontEnd",
        icon: "https://bigfrontend.dev/static/img/logo@192x192.png",
        desc: "前端开发题库平台，系统化练习与面试题解析，助力开发者进阶",
        link: "https://bigfrontend.dev/zh",
      },
    ],
  },
];
